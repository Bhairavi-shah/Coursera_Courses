...
def is_valid_word(wordlist, word):
    ...
    True
    >>> is_valid_word(['APPLE', 'DEAD'], 'HAPPY')
    False
    """
...
def make_str_from_column(board, column_index):
    ...
    'NS'
    >>> make_str_from_column([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B'], ['A', 'B', 'C', 'D']], 3)
    'TBD'
    """
    res = ""
    for i in range(len(board)):
        res += board[i][column_index]
    return res
...
def board_contains_word_in_row(board, word):
    ...
    True
    >>> board_contains_word_in_row([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B'], ['A', 'B', 'C', 'D']], 'BD')
    False
    """
